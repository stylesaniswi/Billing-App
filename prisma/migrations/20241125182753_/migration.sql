/*
  ...
  - You are about to drop the column `noteImages` on the `Invoice` table. All the data in the column will be lost.
...
CREATE TABLE "NoteImage" (
    ...
    CONSTRAINT "NoteImage_invoiceId_fkey" FOREIGN KEY ("invoiceId") REFERENCES "Invoice" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
